            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <td> <div class="progress progress-striped active">
                            <div class="bar" style="width: <?php echo floor(($done / $total) * 100) . "%" ?>"></div>
                        </div> </td>
                    ...
                    <td><center><a href='curso.php?option=eliminar&idCurso=<?php $data['id_course'] ?>' class='btn btn-danger btn-small'><i class='icon-remove icon-white'></i> Eliminar</a></center></td>
