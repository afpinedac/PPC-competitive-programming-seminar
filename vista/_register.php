<div class="container-fluid">
    <div class="row-fluid">
        <div class="span5 offset3"> 
            <div class="well">
                <h1 style="float:left">Registro</h1>
                <h4 style="float:right"><a href="index.php">Volver</a></h4>
                ...
                <div class="row-fluid " >   
                    ...
                    <form class="form-horizontal pull-left" method="post" name="reg" action="registro.php?option=registrar">
                        ...
                        <div class="span1 offset3">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="inputPassword">Repetir Password</label>
                                <div class="controls">
                                    <input type="password" id="inputPassword" name="password2" placeholder="Contraseña">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                <div class="controls">               
                                    <button type="submit"  onClick=" return validar();" class="btn btn-primary">Registrarme</button>
                                </div>
                            </div>
